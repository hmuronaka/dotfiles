...
let g:apex_tooling_force_dot_com_path = "/Users/hmuronaka/bin/tooling-force.com-0.3.6.3.jar"
if !exists("g:apex_backup_folder")
  " full path required here, relative may not work
  let g:apex_backup_folder="/Users/hmuronaka/temp/apex/backup"
endif
if !exists("g:apex_temp_folder")
  " full path required here, relative may not work
  let g:apex_temp_folder="/users/hmuronaka/temp/apex/deployment"
endif
if !exists("g:apex_properties_folder")
  " full path required here, relative may not work
  let g:apex_properties_folder="/Users/hmuronaka/temp/apex/secure-properties"
endif
